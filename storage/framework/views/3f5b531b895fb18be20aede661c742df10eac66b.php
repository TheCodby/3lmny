			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarContent">
					<ul class="navbar-nav index ms-auto">
							<li class="nav-item ms-3 mt-2 mt-md-0 fs-6"><a type="button" href="<?php echo e(route('materials')); ?>" class="navbar-btn menu-item text-light"> <?php echo e(ucfirst(__('buttons.materials'))); ?></a></li>
							<?php if(auth()->guard()->guest()): ?>
								<li class="nav-item ms-3 mt-2 mt-md-0 fs-6"><a type="button" class="menu-item text-light" href="<?php echo e(route('login')); ?>"> <?php echo e(ucfirst(__('buttons.login'))); ?></a></li>
							<?php endif; ?>
						<?php if(auth()->guard()->check()): ?>
							<li class="nav-item ms-3 mt-2 mt-md-0 fs-6"><a type="button" href="#" class="navbar-btn menu-item text-light"> <?php echo e(ucfirst(__('buttons.donate'))); ?></a></li>
